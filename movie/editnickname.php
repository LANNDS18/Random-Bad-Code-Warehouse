    ...
    try {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            if (strlen($_POST["nickname"]) > 0) {
                ...
                $sql_update1 = "update user set nickname='$new_nickname' where email = '$Session_email'";
        ...
        echo "<form  method='post'>
             <textarea name='nickname' style='resize:none;width:300px;height:100px;'placeholder='Edit Nickname here!'></textarea>
